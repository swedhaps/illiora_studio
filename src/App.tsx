...
import CategoryWorks from './pages/CategoryWorks';
...
const fabActions = [
  ...
  },
  {
    icon: <EmailSVG />,
    label: "Email",
    href: "https://mail.google.com/mail/?view=cm&fs=1&to=illiorastudio111@gmail.com&su=Project%20Enquiry",
  },
];
    ...
    <>
      ...
      <div style={{ cursor: "none" }}>
        ...
        <Routes>
          ...
          <Route path="/works/category/:category" element={<CategoryWorks />} />
        </Routes>
      </div>
